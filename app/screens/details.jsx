...
const Details = ({ navigation }) => {
    ...
    const [textField, settextField] = useState("I can't believe I recieved a gift from him.");
    const [answer, setAnswer] = useState("received");
    ...
    const handleKeyPress = (keyValue) => {
        ...
        if (keyValue === 'backspace') {
            ...
            if (Round === 1) {
                let new_text = "I can't belive it's raining agan.";
                settextField(new_text);
                let new_answer = "again";
                setAnswer(new_answer);
            }
            else if (Round === 2) {
                let new_text = "I was so exited to go to the park.";
                settextField(new_text);
                let new_answer = "excited";
                setAnswer(new_answer);
            }
            else if (Round === 3) {
                let new_text = "I have to go to the store to buy some groseries.";
                settextField(new_text);
                let new_answer = "groceries";
                setAnswer(new_answer);
            }
            else if (Round === 4) {
                let new_text = "I have to go to the store to buy some groseries.";
    ...
    if (isGameFinished) {
        return (
            <View style={{ flex: 1, alignItems: 'center' }}>
                <ImageBackground source={require('../../assets/imgs/game_back/game_detail_fullscreen.webp')} style={{ width: '100%', height: '100%' }}>
        ...
        return (
            <View style={{ flex: 1, alignItems: 'center' }}>
                <ImageBackground source={require('../../assets/imgs/game_back/game_detail_fullscreen.webp')} style={{ width: '100%', height: '100%' }}>
                    ...
                    >{textField}</Text>
                    <TextInput style={{
                        width: 350, height: 60, borderRadius: 10, backgroundColor: '#ffffff', justifyContent: 'center', alignItems: 'center', borderColor: '#000000', borderWidth: 3, padding: 20, fontSize: 16, textAlign: 'center', marginLeft: 20, marginRight: 20, marginTop: 400
                    }}
