...
const Conversions = ({ navigation }) => {
    ...
    const handleKeyPress = (keyValue) => {
        ...
        if (keyValue === 'backspace') {
            ...
            let correct_conversion = Number * 2.2;
    ...
    if (isGameFinished) {
        return (
            <View style={{ flex: 1, alignItems: 'center' }}>
                <ImageBackground source={require('../../assets/imgs/game_back/game_conversion_fullscreen.webp')} style={{ width: '100%', height: '100%' }}>
    ...
    if (isBlackBackground) {
        ...
        return (
            <View style={{ flex: 1, alignItems: 'center' }}>
                <ImageBackground source={require('../../assets/imgs/game_back/game_conversion_fullscreen.webp')} style={{ width: '100%', height: '100%' }}>
                    <TouchableOpacity onPressOut={() => Alert.alert('HINT', 'Conversion is the process of changing a number from one form to another. The Conversion formula for kg to g is 1kg = 1000g. The formula for kg to pound is 1kg = 2.2lb.')}
                    >
